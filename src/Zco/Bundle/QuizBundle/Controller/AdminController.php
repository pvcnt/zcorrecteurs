...
/**
 * Controller handling all administrative actions related to quiz.
 */
class AdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return render_to_response('ZcoQuizBundle:Admin:index.html.php', [
            'quizList' => $quizList,
        ]);
    }
    ...
    public function newQuestionAction($quizId)
    {
        ...
        return render_to_response('ZcoQuizBundle:Admin:newQuestion.html.php', [
            'quiz' => $quiz,
        ]);
    }
    ...
    public function editQuestionAction($id)
    {
        ...
        return render_to_response('ZcoQuizBundle:Admin:editQuestion.html.php', [
            'question' => $question,
        ]);
    }
    ...
    public function editQuizAction($id)
    {
        ...
        return render_to_response('ZcoQuizBundle:Admin:editQuiz.html.php', [
            'quiz' => $quiz,
            'questions' => $questions,
            'categories' => $categories,
            'levels' => \Quiz::LEVELS,
    ...
    public function deleteQuestionAction($id, Request $request)
    {
        ...
        return render_to_response('ZcoQuizBundle:Admin:deleteQuestion.html.php', [
            'question' => $question,
        ]);
    }
    ...
    public function deleteQuizAction($id, Request $request)
    {
        ...
        return render_to_response('ZcoQuizBundle:Admin:deleteQuiz.html.php', array('quiz' => $quiz));
    }
    ...
    public function moveQuestionAction($id)
    {
        ...
        return render_to_response('ZcoQuizBundle:Admin:moveQuestion.html.php', [
            'question' => $question,
            'quizList' => $quizList,
            'oldQuiz' => $oldQuiz
        ]);
    ...
    public function popularityAction()
    {
        ...
        return render_to_response('ZcoQuizBundle:Admin:popularity.html.php', [
            'quizList' => $quizList,
        ]);
    }
    ...
    public function statsAction($quizId, Request $request)
    {
        ...
        return render_to_response('ZcoQuizBundle:Admin:stats.html.php', [
            'annee' => $year,
            'mois' => $month,
            'jour' => $day,
            'donnees' => $data,
