...
<p>
	...
	<a href="<?php echo $view['router']->path('zco_user_session_register') ?>">page d'inscription</a>
...
<p>
	...
	<a href="<?php echo $view['router']->path('zco_user_session_newPassword') ?>">demande de nouveau mot de passe</a>.
</p>

<?php $view['javelin']->initBehavior('autofocus', array('id' => $form['pseudo']->vars['id'])) ?>