...
final class CommentDAO
{
     ...
     * @return array
     */
    public static function ListerCommentairesBillet($id, $page)
    {
     ...
     * @return integer
     */
    public static function CompterCommentairesBillet($id)
    {
        $dbh = \Doctrine_Manager::connection()->getDbh();
     ...
     */
    public static function AjouterCommentaire($id, $id_u, $texte)
    {
        $dbh = \Doctrine_Manager::connection()->getDbh();
     ...
     * @return void.
     */
    public static function EditerCommentaire($id, $id_u, $texte)
    {
        $dbh = \Doctrine_Manager::connection()->getDbh();
     ...
     * @return integer
     */
    public static function TrouverPageCommentaire($id_comm, $id_billet)
    {
        $dbh = \Doctrine_Manager::connection()->getDbh();
     ...
     *
     * @param array $infos Infos sur le billet.
     * @param array $comms La liste des commentaires.
     */
    public static function MarquerCommentairesLus($infos, $comms)
    {
        $dbh = \Doctrine_Manager::connection()->getDbh();
     ...
     * @return array
     */
    public static function InfosCommentaire($id)
    {
        $dbh = \Doctrine_Manager::connection()->getDbh();
