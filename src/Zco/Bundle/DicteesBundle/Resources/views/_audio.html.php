...
<div style="float: left; width: 49%<?php if($n % 2) echo '; text-align: right' ?>">
	...
	?></em>
		-
		<a href="<?php echo $this['messages']->blobUrl('dictees/' . DicteeSon($Dictee, $field)) ?>"
	...
	<?php if ($Dictee->format == 'mp3'): ?>
		<object type="application/x-shockwave-flash" data="/swf/player_mp3.swf" width="200" height="20">
			...
			<param name="FlashVars" value="mp3=<?php echo $this['messages']->blobUrl('dictees/' . DicteeSon($Dictee, $field))
	...
	<?php elseif ($Dictee->format == 'ogg'): ?>
		<audio
			src="<?php echo $this['messages']->blobUrl('dictees/' . DicteeSon($Dictee, $field)) ?>"
			controls="controls">
		</audio>
	<?php endif ?>
</div>
