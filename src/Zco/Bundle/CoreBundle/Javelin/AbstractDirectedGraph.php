...
abstract class AbstractDirectedGraph
{
     ...
     * this requirement.
     *
     * @param     string[]    A list of nodes.
     * @return    string[]    A map of nodes to the nodes reachable along their edges.
     ...
     * you know about.
     *
     * @param     string[]    A map of nodes to the nodes reachable along their edges.
     * @return    $this
     */
     ...
     *
     * @param     string        The node to walk from, looking for graph cycles.
     * @return    string[]|null Returns null if no cycles are reachable from the node,
     ...
     *
     * @param     string            The node to walk from.
     * @param     array                Previously visited nodes.
     * @return    null|array     Null if no cycles are found, or a list of nodes which cycle.
     */
