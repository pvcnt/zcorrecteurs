...
<?php echo $view->render('ZcoCoreBundle:Static:aboutTabs.html.php', array('currentTab' => 'corrigraphie')) ?>
...
<div class="row">
	...
	<div class="span7 well">
		<h2>Faire un don</h2>
		<?php echo $this->render('ZcoCoreBundle:Donate:_form.html.php', array('chequeOuVirement' => false)) ?>
	</div>
</div>