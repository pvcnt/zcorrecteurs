...
class EntityChoiceList extends ArrayChoiceList
{
    ...
    public function __construct($class, $property = null, $query, $choices = null)
    {
        ...
        if (!(null === $query || $query instanceof \Doctrine_Query || $query instanceof \Closure)) {
            throw new UnexpectedTypeException($query, '\Doctrine_Query or \Closure');
        }
        ...
        if ($property) {
            ...
            throw new InvalidArgumentException('Entities passed to the choice field must have a "__toString()" method defined (or you can also override the "property" option).');
        }
     ...
     * @throws UnexpectedTypeException  If the entity does not exist in Doctrine's identity map
     */
