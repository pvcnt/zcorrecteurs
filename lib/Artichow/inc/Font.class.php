...
abstract class awFont
{
     ...
     * @param awPoint $point Draw text at this point
    ...
    {
        $text->setFont($this);
        $driver->string($text, $point, $width);
    }
}
...
class awFont1 extends awPHPFont
{
    public function __construct()
    {
...
class awFont2 extends awPHPFont
{
    public function __construct()
    {
...
class awFont3 extends awPHPFont
{
    public function __construct()
    {
...
class awFont4 extends awPHPFont
{
    public function __construct()
    {
...
class awFont5 extends awPHPFont
{
    public function __construct()
    {
...
class awTuffy extends awFileFont
{
    public function __construct($size)
    {
        parent::__construct('Tuffy', $size);
    }
}

class awTuffyBold extends awFileFont
{
    public function __construct($size)
    {
        parent::__construct('TuffyBold', $size);
    }
}

class awTuffyBoldItalic extends awFileFont
{
    public function __construct($size)
    {
        parent::__construct('TuffyBoldItalic', $size);
    }
}

class awTuffyItalic extends awFileFont
{
    public function __construct($size)
    {
        parent::__construct('TuffyItalic', $size);
    }
}
